...
namespace HeroesData.Parser.Overrides.DataOverrides
{
    public class UnitDataOverride : DataOverrideBase, IDataOverride
    {
        ...
        /// </summary>
        public Dictionary<string, Dictionary<string, Action<Ability>>> PropertyAbilityOverrideMethodByAbilityId { get; } = new Dictionary<string, Dictionary<string, Action<Ability>>>();
        ...
        public void ExecuteAbilityOverrides(IEnumerable<Ability> abilities)
        {
            ...
            {
                if (PropertyAbilityOverrideMethodByAbilityId.TryGetValue(ability.ReferenceNameId, out Dictionary<string, Action<Ability>> valueOverrideMethods))
                {

...
namespace HeroesData.Parser.Overrides
{
    ...
    {
        public HeroOverrideLoader(GameData gameData, int? hotsBuild)
        ...
        protected override void SetOverride(XElement element)
        {
            ...
            TalentPropertyOverride talentOverride = new TalentPropertyOverride(GameData, HotsBuild);
            WeaponPropertyOverride weaponOverride = new WeaponPropertyOverride(GameData, HotsBuild);
            PortraitPropertyOverride portraitOverride = new PortraitPropertyOverride(GameData, HotsBuild);

            string cHeroId = element.Attribute("id").Value;
            ...
            if (!DataOverridesById.ContainsKey(cHeroId))
                DataOverridesById.Add(cHeroId, heroDataOverride);
        }

...
namespace HeroesData.Parser
{
    public class MountParser : ParserBase, IParser<Mount, MountParser>
    {
        ...
        public Mount Parse(params string[] ids)
        {
            ...
            XElement mountElement = GameData.MergeXmlElements(GameData.XmlGameData.Root.Elements("CMount").Where(x => x.Attribute("id")?.Value == id));
        ...
        private void SetMountData(XElement mountElement, Mount mount)
        {
            ...
            {
                XElement parentElement = GameData.MergeXmlElements(GameData.XmlGameData.Root.Elements("CMount").Where(x => x.Attribute("id")?.Value == parentValue));

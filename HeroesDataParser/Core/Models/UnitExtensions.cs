...
public static class UnitExtensions
{
    extension(Unit unit)
    {
        ...
        public void AddAsUnknownSubAbility(Ability ability)
        {
        ...
        /// </summary>
        /// <param name="ability">The <see cref="Ability"/>.</param>
        public void AddLayoutAbility(Ability ability)
        {
        ...
        /// </summary>
        /// <param name="ability">The <see cref="Ability"/> to be added.</param>
        public void AddAsLayoutSubAbilityToAbility(Ability ability)
        {
            // no parent ability id, so no sub ability
            if (ability.ParentAbilityLinkIds.Count < 1 && ability.ParentAbilityElementIds.Count < 1)
                return;
        ...
        public void AssignLayoutSubAbilityToLink(Ability subAbility, LinkId linkId)
        {
        ...
        public void AddAbilityByTooltipTalentElementId(string talentElementId, Ability ability)
        {
        ...
        public List<AbilityLinkId> GetTooltipAbilityLinkIdsByTalentElementId(string talentElementId)
        {
            if (unit.AbilitiesByTooltipTalentElementId.TryGetValue(talentElementId, out List<Ability>? abilities))
            {
                return [.. abilities
        ...
        /// </summary>
        /// <param name="ability">The <see cref="Ability"/> to be added.</param>
        public void AddAsLayoutUnknownSubAbility(Ability ability)
        {
            unit.LayoutAbilityTypeByNameId.TryAdd(ability.AbilityElementId, ability.AbilityType);
        ...
        public void AssignSubAbilityToLink(Ability subAbility, LinkId linkId)
        {

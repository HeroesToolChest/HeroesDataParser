...
namespace HeroesData.Parser.Tests.HeroSkinParserTests
{
    ...
    public class AbathurBoneDataTests : HeroSkinParserBaseTest
    {
        ...
        public void PropertiesTests()
        {
            ...
            Assert.AreEqual("Abathur, the Evolution Master of Kerrigan's Swarm, works ceaselessly to improve the zerg from the genetic level up. His hate for chaos and imperfection almost rivals his hatred of pronouns.", AbathurCommonSkin.InfoText.RawDescription);

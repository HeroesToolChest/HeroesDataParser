...
This repository uses [ImageSharp](https://github.com/SixLabors/ImageSharp). In accordance with its licensing terms, a [SixLabors License](https://licensing.sixlabors.com/) is required to build the code.

Place the license file in the root directory of the repository.
